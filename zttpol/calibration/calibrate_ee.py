...
def calibrate_ee(self: Calibrator, events: ak.Array, **kwargs) -> ak.Array:
    """
...
@calibrate_ee.init
def calibrate_ee_init(self: Calibrator, **kwargs) -> None:
    super(calibrate_ee, self).init_func(**kwargs)
