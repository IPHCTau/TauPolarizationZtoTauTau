...
def calibrate_mumu(self: Calibrator, events: ak.Array, **kwargs) -> ak.Array:
    """
...
@calibrate_mumu.init
def calibrate_mumu_init(self: Calibrator, **kwargs) -> None:
    super(calibrate_mumu, self).init_func(**kwargs)
