...
@jec.setup
def jec_setup(self: Calibrator, reqs: dict, inputs: dict, reader_targets: law.util.InsertableDict) -> None:
    """
...
@jer.setup
def jer_setup(self: Calibrator, reqs: dict, inputs: dict, reader_targets: law.util.InsertableDict
              ) -> None:
    """
