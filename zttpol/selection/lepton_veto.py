...
#from zttpol.selection.debug import debug_extra_lepton_veto, debug_double_lepton_veto
...
def extra_lepton_veto(
    ...
    has_pair = ak.num(hcand_pair.pt, axis=-1) == 2
    ...
    #has_extra_lepton = ak.where(has_pair, 
    #                            ak.any(dr_mask, axis=-1),
    #                            dummy)

    has_extra_lepton = ak.any(dr_mask, axis=-1)
